        ...
        switch (choice) 
        {
            ...
            case 2:
                ...
                while (true) 
                {
                    ...
                    cout << "Invalid input. Product category must not contain numbers or be empty.";
                    else break;
                }
                break;
            case 3:
            ...
            case 5:
                ...
                while (true) {
                    ...
                    if (cin.fail() || Reorder_level[index] < 0) {
                        cin.clear();
                        cin.ignore(100, '\n');
                        cout << "Invalid reorder level. Must be a non-negative integer.";
                    } else break;
                }
                break;
            case 0:
